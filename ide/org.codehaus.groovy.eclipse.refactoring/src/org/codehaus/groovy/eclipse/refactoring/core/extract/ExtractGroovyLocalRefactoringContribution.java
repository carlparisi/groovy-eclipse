...
public class ExtractGroovyLocalRefactoringContribution extends
    ...
    public RefactoringDescriptor createDescriptor(String id, String project,
        ...
        return RefactoringSignatureDescriptorFactory.createExtractLocalDescriptor(project, description, comment,
                        arguments, flags);
    }
