//Modified copy from: org.eclipse.jdt.internal.ui.javaeditor.SemanticHighlightingPresenter
...
//						continue;
    ...
    // GROOVY make public
    public List fPositions = new ArrayList();
    // GROOVY end
	...
	public Runnable createUpdateRunnable(final TextPresentation textPresentation, List addedPositions, List removedPositions) {
		...
		// GROOVY use our HighlightedPosition class
