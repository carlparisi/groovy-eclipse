///Copied and patched to fix http://jira.codehaus.org/browse/GROOVY-5140
...
class ASTTransformationCustomizer extends CompilationCustomizer implements CompilationUnitAware {
 ...
 // TWO-OH-UPDATE - if we have no changes, delete this file
		//GRECLICPSE start: patch up for http://jira.codehaus.org/browse/GROOVY-5140
		//return classes?classes[0]:Class.forName(classesAsStrings[0])
     //   return classes?classes[0]:Class.forName(classesAsStrings[0], false, anAnnotationClass.getClassLoader())
		//GRECLICPSE end: patch up for http://jira.codehaus.org/browse/GROOVY-5140
    }
